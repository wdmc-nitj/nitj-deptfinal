...
export const Center = () => {
  ...
  const center=useParams()?.center;
    // const department =useFetch(`/dept/${center}/description`)?.data;
  return (
    <div>
    <div className='flex flex-col md:flex-row w-[98%] justify-around items-center p-2 md:p-4 pb-0 place-items-center mx-auto'>
            ...
            <img className="object-fill w-full h-full" src={props.departmentimage} alt="..." />
                ...
                <div className="px-2 pt-5 h-[300px] sm:h-[340px]">
                    <h1 className='text-[#0054A6] text-center text-lg lg:text-xl font-semibold leading-tight tracking-wide mb-3'>Center of {props.name}</h1>
